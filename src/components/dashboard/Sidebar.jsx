...
import { Banknote, Bookmark, Building2, CreditCard, FileText, LayoutGrid, Settings, Users } from "lucide-react";
...
export async function DashboardSidebar() {
  ...
  const adminNavLinks = [
    ...
    { icon: Banknote, href: "/dashboard/admin/payments", label: "Payments" },
  ...
  return (
    <>
      {/* Desktop sidebar — self-stretch makes the border run full screen height */}
      <aside className="hidden w-64 shrink-0 border-r border-default p-4 self-stretch lg:block">
        {navContent}
      </aside>
